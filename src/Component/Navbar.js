...
export default class navbar extends Component {
  ...
  <div className="container-fluid">
    <Link className="navbar-brand nav-link text-light" to="/">News</Link>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li className="nav-item">
          <Link className="nav-link nav-link text-light " to="/">Home</Link >
        </li>
        <li className="nav-item">
          <Link className="nav-link nav-link text-light " to="/business">Business</Link >
        </li>
        <li className="nav-item">
